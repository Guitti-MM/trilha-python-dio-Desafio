...
def menu():
    ...
    => """
    return input(texwrap.dedent(menu))

def depositar(saldo, valor, extrato, /):
    if valor > 0:
        saldo += valor
        extrato += f"Depósito: \tR$ {valor:.2f}\n"
        print("\n=== Desósito realizado com sucesso! ===")
    else:
        print("\n@@@ Operação invalida!!! Verifique o valor informado @@@")
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        ...
        print("\n@@@ Operação falhou! O valor do saque excee o limite. @@@")
...
def criar_usuario(usuarios):
    cpf = imput("Informe o CPF (somente número):")
